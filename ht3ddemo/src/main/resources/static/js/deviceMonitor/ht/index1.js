...
function init() {
     g3d.getView().style.background = 'url("js/deviceMonitor/ht/img/背景图1.png") no-repeat center';
    ...
    //页面首次加载楼层1场景json文件
    ht.Default.xhrLoad('js/deviceMonitor/ht/floor1/scenes/楼层1.json', function(text) {
